...
var (
	ErrUnknownBook = errors.New("codex.book: unable to determine book")
	ErrBadID       = errors.New("codex.book: provided ID does not correspond to a book")
)
